...
const getQuestionAndAnswer = () => {
  ...
  const [correctAnswer, progressionWithHiddenNumber] = hideRandomProgressionElement(arithmeticProgression);

  const question = `Question: ${progressionWithHiddenNumber.join(' ')}`;
